...
namespace Chat.Tests.Services.Tests
{
    ...
    public class UserAuthServiceTests
    {
        ...
        public void Setup()
        {
            ...
            _userAuthService = new UserAuthService(_mockUserManager.Object, _mockConfiguration.Object, _mockMapper.Object, _environmentMock.Object);
        }
        [Test]
        public async Task CreateTokenAsync_ReturnsToken()
        {
            ...
            _mockConfiguration.Setup(m => m["Jwt:Audience"])
